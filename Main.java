...
public class Main extends Canvas {
    ...
    public static void main(String s[]) {
        final JFrame f = new JFrame("Задание 1");
        ...
        Frame felements= new Frame("Задание 2");
        ...
        final Frame fy = new Frame("Задание 3");
        ...
        final Frame fb = new Frame("Задание 4");
        ...
        final Frame fs = new Frame("Задание 5");
